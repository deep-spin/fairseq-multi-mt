...
fairseq-train \
    ...
    --load-pretrained-encoder-from /mnt/data/bpop/wmt-multi/flores101_mm100_615M/model.pt \
    --load-pretrained-decoder-from /mnt/data/bpop/wmt-multi/flores101_mm100_615M/model.pt \
    --discard-pretrained-encoder-embeddings \
    --discard-pretrained-decoder-embeddings \
    --homogeneous-batch \
    --encoder-embed-path /mnt/data/bpop/wmt-multi/flores_filtered_emb.txt
