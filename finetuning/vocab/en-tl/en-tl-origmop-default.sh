...
# basic finetuning of the task 2 languages. This model uses a MOP vocabulary,
# but one learned on all languages, even though it's only trained on English
# and Tamil.
...
fairseq-train \
    ...
    --finetune-from-model /mnt/data/bpop/wmt-multi/flores_small_task2_vocab/model.pt \
