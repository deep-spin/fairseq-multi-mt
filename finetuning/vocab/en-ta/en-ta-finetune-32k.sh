...
# After training only the embeddings on the en<>ta data, finetune all parameters
...
fairseq-train \
    /mnt/data/bpop/wmt-multi/filtered-data/task2/en-ta-32-cat/bin/ \
    --finetune-from-model /mnt/data/bpop/wmt-multi/bathwater/models/en-ta-cat-32k-train-embeddings-lr-flat/checkpoint_last.pt \
